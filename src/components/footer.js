...
<Link to={'/randomCity'}>Get Inspired</Link><img src={Inspo2} alt="travel inspiration"/>
</div>
<div className="square">
<Link to={'/addCity'}>Add a City</Link><img src={Shanghai} alt="city"/>
</div>
<div className="square">
<Link to={'/cities'}>All Cities</Link><img src={NightCities} alt="destination"/>
</div>
</div>
